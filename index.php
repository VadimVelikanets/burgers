...
<html lang="ru">
  ...
  <body>
    ...
    if( isset($_POST['name']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['street']) && isset($_POST['home']) && isset($_POST['part']) && isset($_POST['appt']) && isset($_POST['floor']) && isset($_POST['comment']))
    {
      ...
      $query2 = "INSERT INTO orders (id_users, street, house, corps, flat, flour, comment) VALUES ('$last_id', '$street' ,  '$home',  '$part', '$appt', '$floor', '$comment')";
                ...
                <div class="order__form-col">
                  ...
                  <div class="order__form-buttons">
                    ...
                    <div class="order__form-row">
                      ...
                      <?php if(isset($success)) { ?> <h3 style="color: #fff;"><?php echo $success; ?><h3> <?php } ?> 
                     <?php if(isset($error)) { ?> <h3 style="color: red;"><?php echo $error; ?><h3> <?php } ?> 
